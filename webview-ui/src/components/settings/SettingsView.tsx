...
const SettingsView = forwardRef<SettingsViewRef, SettingsViewProps>(({ onDone, targetSection }, ref) => {
	...
	const handleSubmit = () => {
		if (isSettingValid) {
			...
			vscode.postMessage({ type: "subagentApiConfigId", text: subagentApiConfigId || "" })
				...
				<TabContent ref={contentRef} className="p-0 flex-1 overflow-auto">
					...
					{activeTab === "autoApprove" && (
						<AutoApproveSettings
							...
							alwaysAllowParseAst={cachedState.alwaysAllowParseAst}
							alwaysAllowSplitFile={cachedState.alwaysAllowSplitFile}
