...
vitest.mock("../../task/CommandApprovalHelper", () => ({
	CommandApprovalHelper: {
		shouldAutoApproveCommand: vitest.fn(() => false),
		getApprovalReason: vitest.fn(() => "test reason"),
	},
}))
