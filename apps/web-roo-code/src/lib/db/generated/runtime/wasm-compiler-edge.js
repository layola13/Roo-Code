...
function Tu(e) {
	let t = { color: us[Pu++ % us.length], enabled: Yt.enabled(e), namespace: e, log: Yt.log, extend: () => {} },
		r = (...n) => {
			let { enabled: i, namespace: o, color: s, log: a } = t
			if ((n.length !== 0 && zt.push([o, ...n]), zt.length > xu && zt.shift(), Yt.enabled(o) || i)) {
...
function ms(e = 7500) {
	let t = zt.map(([r, ...n]) => `${r} ${n.map((i) => (typeof i == "string" ? i : JSON.stringify(i))).join(" ")}`)
		.join(`
`)
...
function Bp(e, t, r) {
	let n = {}
	return (
		e.modelOrType && !e.isRawAction() && ((n.$composites = !0), (n.$scalars = !0)), t && jp(n, t, e), Qp(n, r, e), n
	)
}
function jp(e, t, r) {
...
async function Ln({ query: e, tracingHelper: t, provider: r, onQuery: n, execute: i }) {
	return await t.runInChildSpan(
		{ name: "db_query", kind: Er.CLIENT, attributes: { "db.query.text": e.sql, "db.system.name": Cm(r) } },
		async () => {
			let o = new Date(),
				s = b.now(),
				a = await i(),
...
var No =
		...
		(r) => {
			...
			return (
				i?.values ? Mc(`prisma.${e}(${n}, ${i.values})`) : Mc(`prisma.${e}(${n})`), { query: n, parameters: i }
			)
		},
	Nc = {
	...
	class t {
		...
		constructor(n) {
			...
			let o = e.relativeEnvPaths && {
					...
					schemaEnvPath:
						e.relativeEnvPaths.schemaEnvPath && rn.resolve(e.dirname, e.relativeEnvPaths.schemaEnvPath),
				},
				s
			if (n?.adapter) {
				s = n.adapter
