		...
		Pa = li((e) => {
			...
			function g(C) {
				...
				return (
					...
					L === 1 &&
						((S =
							(r[C.charCodeAt($)] << 10) | (r[C.charCodeAt($ + 1)] << 4) | (r[C.charCodeAt($ + 2)] >> 2)),
						(O[q++] = (S >> 8) & 255),
						(O[q++] = S & 255)),
					O
				)
...
var U = (function () {
	...
	return function (n, i, o, s, a, l) {
		...
		if (!ee || !ee[0] || !B || !B[0])
			return new tr(
				!n.s || !i.s || (ee ? B && ee[0] == B[0] : !B) ? NaN : (ee && ee[0] == 0) || !B ? Zr * 0 : Zr / 0,
			)
		for (
	...
	class t {
		...
		constructor(n) {
			...
			let o = e.relativeEnvPaths && {
					...
					schemaEnvPath:
						e.relativeEnvPaths.schemaEnvPath && Re.resolve(e.dirname, e.relativeEnvPaths.schemaEnvPath),
				},
				s
			if (n?.adapter) {
				s = n.adapter
