...
You may have to run ${qe("prisma generate")} for your changes to take effect.`,
	...
	async start() {
		if (
			...
			return (
				Re(`library already starting, this.libraryStarted: ${this.libraryStarted}`), this.libraryStartingPromise
			)
	...
	class r {
		...
		constructor(n) {
			...
			let o = e.relativeEnvPaths && {
					rootEnvPath:
						e.relativeEnvPaths.rootEnvPath && ri.default.resolve(e.dirname, e.relativeEnvPaths.rootEnvPath),
					schemaEnvPath:
