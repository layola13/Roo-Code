...
var Le,
	...
	vn = ie(() => {
		...
		S.toDecimalPlaces = S.todp = function (t, e) {
			...
			return (
				(r = new n(r)),
				t === void 0 ? r : (ce(t, 0, Le), e === void 0 ? (e = n.rounding) : ce(e, 0, 8), L(r, t + $(r) + 1, e))
			)
		}
...
function Zt({ args: t, errors: e, errorFormat: r, callsite: n, originalMethod: i, clientVersion: o, globalOmit: s }) {
	...
	let { message: f, args: h } = Xt(a, r),
		C = jt({ message: f, callsite: n, originalMethod: i, showColors: r === "pretty", callArguments: h })
...
var Tt = class {
	...
	async start() {
		if (
			...
			return (
				ge(`library already starting, this.libraryStarted: ${this.libraryStarted}`), this.libraryStartingPromise
			)
...
var ln =
		...
		(r) => {
			...
			return (
				i?.values ? Ao(`prisma.${t}(${n}, ${i.values})`) : Ao(`prisma.${t}(${n})`), { query: n, parameters: i }
			)
		},
	Ro = {
	...
	class e {
		...
		constructor(n) {
			...
			let o = t.relativeEnvPaths && {
					...
					schemaEnvPath:
						t.relativeEnvPaths.schemaEnvPath && Ut.resolve(t.dirname, t.relativeEnvPaths.schemaEnvPath),
				},
				s
			if (n?.adapter) {
				s = n.adapter
